@extends('layouts.app')
@section('title', 'DASHBOARD-JEFEINMEDIATO')
@section('class', 'DASHBOARD-JEFEINMEDIATO')
    ...
    <div class="flex items-center relative">
        ...
        <div class="absolute right-0 top-full mt-2 w-48 bg-white shadow-lg rounded-md hidden" id="user-menu">
            <div class="px-4 py-2">
                ...
                <h2 class="text-gray-600">Rol: Jefe Inmediato</h2>
            </div>
            <ul>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="bg-white border border-gray-300 rounded-lg p-4 flex flex-col relative w-[19rem] h-48 mr-4 shadow-lg">
            ...
            <div class="flex items-start mb-2">
                ...
                <div class="items-center">
                    <h2 class="text-lg font-semibold">APRENDICES</h2>
                </div>
            </div>

            <div class="flex flex-col mt-auto">
                <p class="text-gray-900 mb-4">TOTAL APRENDICES: 10</p>
        ...
        <div class="bg-white border border-gray-300 rounded-lg p-4 flex flex-col relative w-[19rem] h-48 mr-4 shadow-lg">
            ...
            <div class="flex items-start mb-2">
                ...
                <div class="items-center">
                    <h2 class="text-lg font-semibold">EMPRESA</h2>
                </div>
            </div>
