...
<body class="bg-gray-50 dark:bg-gray-800">
  <main>
    <header
      class="flex items-center justify-between bg-[#f9faf9] h-24 px-4 leading-6 text-[#111211] border-b border-[#faf9f9] border-solid sm:grid sm:auto-cols-auto sm:grid-cols-3 sm:px-6 lg:px-8">
      ...
      <nav class="flex sm:col-span-1 mr-2" aria-label="Breadcrumb">
        <ol role="list" class="flex items-center space-x-1 sm:space-x-2">
          ...
          <!-- ICONO DE sena-->
          <li class="hidden lg:block mr-64">
          ...
          <li>
            <div class="flex items-center">
              <h1 class="lg:ml-2 text-sm font-medium text-gray-500 hover:text-gray-700"
                >Practiview</h1>
            </div>
          </li>
    ...
    <section
      class="flex items-center justify-between bg-[#5eb319] h-16 px-4 leading-6 text-[#111211] border-b border-gray-200 border-solid sm:grid sm:auto-cols-auto sm:grid-cols-3 sm:px-6 lg:px-8">
