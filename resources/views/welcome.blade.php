...
<body class="bg-gray-50 dark:bg-gray-800">
  <main>
    <header
    class="flex items-center justify-between bg-[#f9faf9] h-16 px-4 leading-6 text-[#111211] border-b border-gray-200 border-solid sm:grid sm:auto-cols-auto sm:grid-cols-3 sm:px-6 lg:px-8">

      <nav class="flex sm:col-span-1 mr-2" aria-label="Breadcrumb">
        <dol role="list" class="flex items-center space-x-1 sm:space-x-2">
          <div class="logo"> <a class="gwt-Anchor" href="http://www.sena.edu.co/Paginas/Inicio.aspx"
              target="_blank"><img border="0" height="75" src="images/transparencia.png" width="85"></a> </div>
          <div class="logos">
            <div class="vocacional"> <a class="gwt-Anchor" href="https://orientacionvocacional.sena.edu.co/"
                target="_blank"><h1>Practiview</h1></a> </div>
            <div class="NewLogoEncabezado"> <a class="gwt-Anchor" href="https://zajuna.sena.edu.co/bilinguismo.php"
                target="_blank"><img border="0" height="136" src="images/transparencia.png" width="137"></a> </div>
            <div class="mintrabajo"> </div>
          </div>
        </dol>
      </nav>
    ...
    <section class="flex items-center justify-between bg-[#5eb319] h-16 px-4 leading-6 text-[#111211] border-b border-gray-200 border-solid sm:grid sm:auto-cols-auto sm:grid-cols-3 sm:px-6 lg:px-8">

       <!-- barra de navbar parte superior-->
       <nav class="flex sm:col-span-1 mr-2" aria-label="Breadcrumb">
        <ol role="list" class="flex items-center space-x-1 sm:space-x-2">

          <!-- ICONO DE sena-->
          <!-- <li class="hidden lg:block">
                        <div class="items-center mr-6">
                            <img src="../../public/images/sena.png" alt="sena">
                        </div>
                    </li> -->
          ...
          <li>
            <div class="flex items-center">
              <svg class="flex-shrink-0 hidden w-5 h-5 text-gray-300 lg:block" xmlns="http://www.w3.org/2000/svg"
                fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                <path d="M5.555 17.776l8-16 .894.448-8 16-.894-.448z"></path>
              </svg>
              <a class="lg:ml-2 text-sm font-medium text-gray-500 hover:text-gray-700"
          ...
          <li>
            <div class="flex items-center">
              ...
              <a class="ml-1 sm:ml-2 text-sm font-medium text-[#111211] hover:text-[#edeeed]"
                href="/resources/flowbite-admin-dashboard">Flowbite Admin Dashboard</a>
            </div>
          </li>
        </ol>
      </nav>
      ...
      <div class="flex items-center">
        ...
        <div
          ...
          style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1121px, 465px);"
        ...
        <div
          ...
          id="apps-dropdown"
          style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1161px, 465px);"
          data-popper-placement="bottom">
          <div
            class="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            Apps
        ...
        <div id="tooltip-toggle" role="tooltip"
          ...
          style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1129px, 63px);"
          data-popper-placement="bottom">
          Toggle dark mode
        ...
        <div class="flex items-center ml-3">
          ...
          <div
            ...
            id="dropdown-2"
            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1249px, 461px);"
            data-popper-placement="bottom">
      ...
      <!--Get template-->
      <!-- <div class="flex items-center justify-end text-gray-700 sm:col-span-1">
                <div class="shrink-0">
                    <a class="inline-flex items-center justify-center px-6 py-2 text-sm  font-medium text-white transition duration-150 border border-transparent shadow-sm rounded-2xl bg-cool-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cool-indigo-500"
                        target="_blank" href="https://github.com/themesberg/flowbite-admin-dashboard">Get template</a>
                </div>
            </div> -->
    ...
    <!--es como el fondo de pantalla donde va a ir el menu-->
    <section class=" bg-[#5fd7d3] px-4 py-8 leading-6 text-gray-700 sm:px-6 lg:px-8">

      <!--es como el fondo de pantalla donde va a ir el menu-->
      <div class="w-full mx-auto duration-500 ease-in-out transform max-w-screen-3xl"
        data-class-toggler-target="toggleable">
        <div class="relative">
          <div class="overflow-hidden shadow-xl rounded-xl " style="transform-origin: right center;">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center justify-start">
                    ...
                    <button id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar"
                      class="p-2 text-gray-600 rounded cursor-pointer lg:hidden hover:text-gray-900 hover:bg-[#32628f] focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
