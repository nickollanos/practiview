...
<main class="flex-grow container mx-auto flex flex-col items-center justify-center space-y-4 min-h-screen px-4">
    <!-- Tarjeta centrada -->
    <div class="bg-white opacity-80 shadow-lg rounded-lg p-6 w-full max-w-md min-h-[25rem] flex flex-col items-center justify-center space-y-4 border border-solid border-[#059212] relative">
