...
<main class="container mx-auto px-4 py-2 mt-2 space-y-2 pt-16 sm:pt-8 lg:pt-6 pb-16 min-h-screen flex flex-col justify-between">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-2">
        ...
        <div
            ...
            <strong class="text-3xl font-extraboldfont-poppins text-[#0C0C0C] text-opacity-50">{{ $cantidadAprendices }}</strong>
        </div>
        <div
            class="bg-[#EBE9D6] shadow-lg rounded-lg p-1 max-h-16 flex flex-col items-center border border-solid border-[#059212]">
            <h1 class="text-[12px] font-bold font-poppins text-[#0C0C0C] text-opacity-50">Cantidad de Aprendices en Practica</h1>
            <strong class="text-3xl font-extrabold font-poppins text-[#0C0C0C] text-opacity-50">{{ $aprendicesPorEstado['Productiva'] }}</strong>
        </div>
        <div
            class="bg-[#EBE9D6] shadow-lg rounded-lg p-1 max-h-16 flex flex-col items-center border border-solid border-[#059212]">
            <h1 class="text-[12px] font-bold font-poppins text-[#0C0C0C] text-opacity-50">Cantidad de Aprendices en Lectiva</h1>
            <strong class="text-3xl font-extrabold font-poppins text-[#0C0C0C] text-opacity-50">{{ $aprendicesPorEstado['Lectiva'] }}</strong>
        </div>
        <div
            class="bg-[#EBE9D6] shadow-lg rounded-lg p-1 max-h-16 flex flex-col items-center border border-solid border-[#059212]">
            <h1 class="text-[12px] font-bold font-poppins text-[#0C0C0C] text-opacity-50">Cantidad de Aprendices Certificados</h1>
            <strong class="text-3xl font-extrabold font-poppins text-[#0C0C0C] text-opacity-50">{{ $aprendicesPorEstado['Certificado'] }}</strong>
        </div>
        <div
            class="bg-[#EBE9D6] shadow-lg rounded-lg p-1 max-h-16 flex flex-col items-center border border-solid border-[#059212]">
            <h1 class="text-[12px] font-bold font-poppins text-[#0C0C0C] text-opacity-50">Cantidad de Aprendices Cancelados</h1>
            <strong class="text-3xl font-extrabold font-poppins text-[#0C0C0C] text-opacity-50">{{ $aprendicesPorEstado['Cancelado'] }}</strong>
        </div>
    </div>


    <!-- Botón para agregar aprendiz -->
    <div class="flex items-center justify-center space-x-4 space-y-2 p-1 max-h-14">
        <a href="#"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2">
        ...
        <!-- Fila 1 -->
        <div class="flex items-start space-x-4 bg-white shadow-lg rounded-lg p-1 max-h-44 border border-solid border-[#059212]">
            <!-- Imagen circular -->
