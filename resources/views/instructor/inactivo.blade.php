@extends('layouts.app')
@section('title', 'INACTIVO-INSTRUCTOR')
@section('class', 'INACTIVO-INSTRUCTOR')
    ...
    <main
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-5 gap-4 mt-10 mb-2">
            ...
            <div
                ...
                <h1 class="text-[12px] font-bold font-poppins text-[#0C0C0C] text-opacity-50">Cantidad de Instructores Inactivos</h1>
                <strong
                    class="text-3xl font-extraboldfont-poppins text-[#0C0C0C] text-opacity-50">{{ $instructoresInactivos }}</strong>
            </div>
        </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <div class="bg-white shadow rounded-lg p-2 border border-solid border-[#059212]">
                                <h1 class="text-lg font-bold text-gray-800">{{ ucwords($instructor->nombre) }}</h1>
                            </div>
                            ...
                            <div class="bg-white shadow rounded-lg p-2 border border-solid border-[#059212]">
                                <div class="flex items-center justify-center space-x-4">
                                    ...
                                    <div class="w-8 h-8 bg-[#059212] rounded-full flex items-center justify-center cursor-pointer">
                                        <a href="javascript:;" class="btn-delete" data-fullname="{{ $instructor->nombre }}" data-action="activate">
