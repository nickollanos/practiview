        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div class="flex items-start space-x-4 bg-white shadow-lg rounded-lg p-4 border border-solid border-[#059212]">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <div class="bg-white shadow rounded-lg p-2 border border-solid border-[#059212]">
                        <div class="flex items-center space-x-2">
                            <h1 class="text-sm font-medium text-gray-600">Acciones:</h1>
                            <img src="{{ asset('images/view-icon.svg') }}" alt="Ver" class="w-5 h-5 cursor-pointer">
                            <img src="{{ asset('images/edit-icon.svg') }}" alt="Editar" class="w-5 h-5 cursor-pointer">
                            <img src="{{ asset('images/delete-icon.svg') }}" alt="Eliminar" class="w-5 h-5 cursor-pointer">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <div class="bg-white shadow rounded-lg p-2 border border-solid border-[#059212]">
                        <div class="flex items-center space-x-2">
                            <h1 class="text-sm font-medium text-gray-600">Acciones:</h1>
                            <img src="{{ asset('images/view-icon.svg') }}" alt="Ver" class="w-5 h-5 cursor-pointer">
                            <img src="{{ asset('images/edit-icon.svg') }}" alt="Editar"
