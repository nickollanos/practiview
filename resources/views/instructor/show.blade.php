                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <div class="bg-[#EBE9D6] shadow-md rounded-lg p-4 border border-solid border-[#059212] w-full">
                            ...
                            <h1 class="text-lg font-bold font-poppins text-[#0C0C0C] text-opacity-50 text-center">lopez</h1>
                        </div>
                        ...
                        <div class="bg-[#EBE9D6] shadow-md rounded-lg p-4 border border-solid border-[#059212] w-full">
                            ...
                            <h1 class="text-lg font-bold font-poppins text-[#0C0C0C] text-opacity-50 text-center">{{ $edad }}                      </h1>
                        </div>             
                    </div>
                </div>
            </div>
